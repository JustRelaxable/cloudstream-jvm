...
import com.tahoshi.cloudstream_jvm.core.plugins.PluginManager.getPluginSanitizedFileName
import com.tahoshi.cloudstream_jvm.core.plugins.PluginManager.unloadPlugin
...
object RepositoryManager {
    ...
    fun convertRawGitUrl(url: String): String {
        if (getKey<Boolean>("jsdelivr_proxy_key") != true) return url
    ...
    suspend fun removeRepository(repository: RepositoryData) {
        val extensionsDir = File(ONLINE_PLUGINS_FOLDER)
